...
@interface FYFTextFieldSupport : NSObject <UITextFieldDelegate>

@property (nonatomic,weak) id<UITextFieldDelegate> delegate;

@end

@implementation FYFTextFieldSupport
...
- (BOOL)textField:(UITextField *)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString *)string {
    ...
    BOOL limitEmoji = ((FYFTextField *)textField).limitEmoji;
    if (limitEmoji && [string isIncludingEmoji]) {
        return NO;
    }
    
    NSInteger maxLength = ((FYFTextField *)textField).maxLength;
    if (maxLength > 0) {
        //增加文字
        if (string.length > 0) {
...
@interface FYFTextField()

@property (nonatomic, strong) FYFTextFieldSupport *textFieldSupport;
@property (nonatomic, strong) UIView *editRightView;
@property (nonatomic, strong) UIButton *eyeButton;

@end

@implementation FYFTextField
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _textFieldSupport = [[FYFTextFieldSupport alloc] init];
...
- (void)textFieldDidChanged:(NSNotification *)notification {
    ...
    if ([notification.object isKindOfClass:[FYFTextField class]]) {
        
        FYFTextField *textField = notification.object;
